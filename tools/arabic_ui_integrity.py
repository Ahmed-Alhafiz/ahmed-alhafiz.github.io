...
def main() -> None:
    ...
    if len(items) != 20:
        errors.append(f"articles/research-index.json: expected 20 current research surfaces, found {len(items)}")
    ...
    print(
        "Arabic UI integrity passed: the Arabic hub is localized, twenty research "
