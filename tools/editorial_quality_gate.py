...
RULES={
 ...
 'articles/quran-science-method-evidence/index.html':dict(words=700,sources=5,book='books/sirou-fi-alard/index.html',route='/articles/quran-science-method-evidence/',medical=False,extended=False),
 'articles/human-embryo-quran-stages/index.html':dict(words=700,sources=5,book='books/sirou-fi-alard/index.html',route='/articles/human-embryo-quran-stages/',medical=False,extended=False),
 'articles/brain-consciousness-spirit-limits/index.html':dict(words=700,sources=5,book='books/sirou-fi-alard/index.html',route='/articles/brain-consciousness-spirit-limits/',medical=False,extended=False),
 'articles/water-life-molecular-properties/index.html':dict(words=700,sources=5,book='books/sirou-fi-alard/index.html',route='/articles/water-life-molecular-properties/',medical=False,extended=False),
 'articles/iron-fire-light-matter-energy/index.html':dict(words=700,sources=8,book='books/sirou-fi-alard/index.html',route='/articles/iron-fire-light-matter-energy/',medical=False,extended=False),
